...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Limit drive motor current to prevent brownouts and excessive current draw
                .withStatorCurrentLimit(Amps.of(80))  // Continuous current limit
                .withStatorCurrentLimitEnable(true)
                .withSupplyCurrentLimit(Amps.of(60))  // Supply current limit from battery
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.080810546875);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.022705078125);
